...
notebook_str = r'''
{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "%%time\n",
    "marked=nrt.mark_weird(df, select_func=lambda x: nrt.select_after_changelog(x, changelog, nmin=8), naive=False, confidence=0.999, col=factor)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "print(nrt.plot_overview(marked, changelog, confidence=0.999))\n",
