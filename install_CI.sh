...
sudo-g5k pip3 install 'matplotlib<3.4.0'  # otherwise, fail with "ImportError: Matplotlib requires pyparsing>=2.2.1; you have 2.2.0"
sudo-g5k pip3 install https://github.com/Ezibenroc/cashew/releases/download/0.2.10/cashew-0.2.10-py3-none-any.whl
cashew --git-version
